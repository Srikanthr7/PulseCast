...
export default function Header() {
  ...
  return (
    <header style={{
      ...
      top: 0,
      zIndex: 50,
      padding: isMobileVote ? '10px 16px' : '14px 24px',
    }}>
      <div style={{
        maxWidth: '1400px',
        margin: '0 auto',
        ...
        <Link to="/" style={{
          ...
          <div style={{
            ...
            boxShadow: '0 0 20px rgba(72, 229, 194, 0.4), inset 0 1px 0 rgba(255, 255, 255, 0.3)',
        ...
        <nav style={{
          ...
          {/* Dynamic link to creator's own active poll */}
          {activePollId ? (
            <Link
